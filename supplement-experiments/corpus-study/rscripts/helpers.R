reshapeCorpusData <- function(d)
{
  d$Trial1 = paste(d$List0,d$Index0,d$Construction0,d$Context0,d$Question0,d$Response0,d$Adj0,d$Tense0,sep = " ")
  d$Trial2 = paste(d$List1,d$Index1,d$Construction1,d$Context1,d$Question1,d$Response1,d$Adj1,d$Tense1,sep = " ")
  d$Trial3 = paste(d$List2,d$Index2,d$Construction2,d$Context2,d$Question2,d$Response2,d$Adj2,d$Tense2,sep = " ")
  d$Trial4 = paste(d$List3,d$Index3,d$Construction3,d$Context3,d$Question3,d$Response3,d$Adj3,d$Tense3,sep = " ")
  d$Trial5 = paste(d$List4,d$Index4,d$Construction4,d$Context4,d$Question4,d$Response4,d$Adj4,d$Tense4,sep = " ")
  d$Trial6 = paste(d$List5,d$Index5,d$Construction5,d$Context5,d$Question5,d$Response5,d$Adj5,d$Tense5,sep = " ")
  d$Trial7 = paste(d$List6,d$Index6,d$Construction6,d$Context6,d$Question6,d$Response6,d$Adj6,d$Tense6,sep = " ")
  d$Trial8 = paste(d$List7,d$Index7,d$Construction7,d$Context7,d$Question7,d$Response7,d$Adj7,d$Tense7,sep = " ")
  d$Trial9 = paste(d$List8,d$Index8,d$Construction8,d$Context8,d$Question8,d$Response8,d$Adj8,d$Tense8,sep = " ")
  d$Trial10 = paste(d$List9,d$Index9,d$Construction9,d$Context9,d$Question9,d$Response9,d$Adj9,d$Tense9,sep = " ")
 return(d) 
} 
...
reshapeAcceptabilityData <- function(d)
{
  ...
  d$Trial10 = paste(d$Lis9,d$ID9,d$Condition9,d$Context9,d$Target9,d$Response9,d$Adj9,d$Contradict9,d$VPinf9,d$Enough9,sep = " ")
  ...
  d$Trial13 = paste(d$List12,d$ID12,d$Condition12,d$Context12,d$Target13,d$Response12,d$Adj12,d$Contradict12,d$VPinf12,d$Enough12,sep = " ")
