...
\begin{xlist}
\ex I wasn't \fbox{fortunate} to live extremely close to my Mom and Dad for most of my adult life. The closest was when I was in Denver and they were in Garden City, KS.
...
carrying the cries. I wasn't \fbox{stupid} to go stumbling through the
...
site. I was not \fbox{fortunate} to visit the 1939-40 World's Fair but I
had an uncle who did.
\\ Question to participants: Is Shawn certain that he visited the 1939-40 World's Fair?

\ex Megan: For sure P1 will not be \fbox{stupid} to create a WiMAX netbook to allow YTL or AMAX customers to use.
\\ Question to participants: Is Megan certain that P1 will create a WiMAX netbook to allow YTL or AMAX customers to use?

\ex Frank: God offers Hope to Hispanics! In His pages are solutions to every immigration problem. God loves citizens and immigrants equally. His solutions are for all of us. They are practical. They work. He is not \fbox{stupid} to think so.
\\ Question to participants: Is Frank certain that God thinks that his solutions work?

\ex Anna: The flight attendants are not \fbox{wise} to invoke the specter
...
\includegraphics[width=.7\paperwidth]{/Users/tonhauser.1/Documents/current-research-topics/NSF-NAI/prop-att-experiments/2evaluative-adjectives/7-corpus-data/graphs/mean-response-by-item-and-adj}
...
\ex God offers Hope to Hispanics! In His pages are solutions to every immigration problem. God loves citizens and immigrants equally. His solutions are for all of us. They are practical. They work. He is not \fbox{stupid} to think so. \hfill {\bf [6.3]}

\ex There is no chance a true large scale museum can be built. The federal government cannot take on the humongous legal liability for such a hazardous site. The Google founders are not \fbox{stupid} to take on that liability either. \hfill {\bf [1.9]}
...
\fbox{fortunate} to be married to Joe? \hfill {\bf [6.4]}

\ex\label{fair}  Mr. Anderson  Just discovered your site on The 1939-40 New York World's Fair. It brought back a lot of memories for me. Thanks for the time you spent in constructing this site. I was not \fbox{fortunate} to visit the 1939-40 World's Fair but I had an uncle who did \hfill {\bf [1.2]}
...
\ex Alice: Good day. My husband and i were married for four years now but before that he already has a child with his ex gf. We are not \fbox{lucky} to have a child of our own. \hfill {\bf [1.4]}
...
hoping he was not \fbox{foolish} to spend his savings on reopening
...
\ex Olmert is a dinosaur politician  he will exist for a long time in politics  and therefore will not be \fbox{foolish} to make the same mistake twice. \hfill {\bf [2.1]}
...
\ex I think Mark Cuban was not \fbox{smart} to let a successful coach go in Avery Johnson. \hfill {\bf [6.7]}
...
will not be \fbox{smart} to keep an eye on web pages that are only easy
...
\begin{exe}
\exi{(i)} With more teams denying interest in Johnson, he will be \fbox{smart}
...
\ex
\begin{xlist}
\exi{A:} There were so few tickets for the show! How did Sam get a ticket?
...
\ex
\begin{xlist}
\exi{A:} Only famous people got a ticket for the show. Luck had nothing to do with it, did it?
...
\exi{B:} Sam wasn't smart to buy one the day they went on sale. (Her sister gave her a ticket.)
...
\includegraphics[width=1\textwidth]{/Users/tonhauser.1/Documents/current-research-topics/NSF-NAI/prop-att-experiments/1factive-verbs/Git-variability/results/exp1a/graphs/subject-projai-stupid}
...
\fbox{stupid} to think so. \hfill {\bf [6.3]}

\ex Out east in St. Bernard Parish  Chad Blanchard is hoping he was not
\fbox{foolish} to spend his savings on reopening Charlie's restaurant
...
Please take a good look at the carriage horse. He was not \fbox{mean}
...
from my baggage  and I was not \fbox{wise} to put my name there  at
...
\fbox{fortunate} to visit the 1939-40 World's Fair but I had an uncle who did. \hfill {\bf [1.2]}


\ex There is no chance a true large scale museum can be built. The federal government cannot take on the humongous legal liability for such a hazardous site. The Google founders are not \fbox{stupid} to take on that liability either. \hfill {\bf [1.9]}

\ex I was not \fbox{fortunate} to be one of the 1500 and I was wondering what you intended for the rest of us. \hfill {\bf [1.3]}
...
\ex I had the pleasure to know you and your son Travis  but I was not \fbox{lucky} to meet you  Thomas. \\ \hspace*{.2cm} \hfill {\bf [1.6]}
...
\ex I like to teach my children about Jesus.  I was not \fbox{fortunate}
...
\fbox{lucky} to have a child of our own. \hfill {\bf [1.4]}
...
to talk about the issue. But Yoder was NOT \fbox{smart} to completely
...
\fbox{lucky} to have recent rains and a several ton machine to drive on
...
they are not \fbox{fortunate} to have a cautious Mullah \hfill {\bf
[5.7]}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=.7]{/Users/tonhauser.1/Documents/current-research-topics/NSF-NAI/prop-att-experiments/2evaluative-adjectives/content-context-experiment/results/graphs/targetmeans-by-condition-and-adj}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=.6]{/Users/tonhauser.1/Documents/current-research-topics/NSF-NAI/prop-att-experiments/2evaluative-adjectives/6-NAI-positive-EAS/results/graphs/proportion-ai-by-condition-and-adj}
...
\ex If he [James Hamilton Doggart] was \fbox{lucky} to escape a German submarine attack in the Channel, he was even more fortunate to survive influenza, contracted while on leave in Cambridge.\footnote{\url{https://en.wikipedia.org/wiki/James_Hamilton_Doggart}}
...
\exi{B:} If they were \fbox{stupid} to leave it running then maybe a few.\footnote{\url{steamcommunity.com/app/730/discussions/0/540744934462316309/}}
...
\ex Of course with the technology we possess today, electronic money is commonplace. [...] perhaps we are \fbox{lucky} to live in the times that we do.\footnote{\url{nrich.maths.org/2587}}

\ex I am seaching [sic] for a remote cabine in Finland that is available for renting. [...]
Region wise I would prefer Lapland or Lakeside. Perhaps we are \fbox{lucky} to see northern lights.\footnote{\url{www.tripadvisor.com/ShowTopic-g189896-i442-k11448709-Remote_rental_cottage-Finland.html}}
...
\hspace*{-.5cm}\includegraphics[scale=.8]{/Users/tonhauser.1/Documents/current-research-topics/NSF-NAI/prop-att-experiments/2evaluative-adjectives/acceptability-experiment/results/graphs/histogram} \includegraphics[scale=.8]{/Users/tonhauser.1/Documents/current-research-topics/NSF-NAI/prop-att-experiments/2evaluative-adjectives/acceptability-experiment/results/graphs/acceptability-rating-difference}
